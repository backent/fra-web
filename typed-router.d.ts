...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'account-request': RouteRecordInfo<'account-request', '/account-request', Record<never, never>, Record<never, never>>,
    'dashboard': RouteRecordInfo<'dashboard', '/dashboard', Record<never, never>, Record<never, never>>,
    'dashboard-category': RouteRecordInfo<'dashboard-category', '/dashboard/:category', { category: ParamValue<true> }, { category: ParamValue<false> }>,
    'dashboard-create-document': RouteRecordInfo<'dashboard-create-document', '/dashboard/create-document', Record<never, never>, Record<never, never>>,
