<template>
  <VDialog v-model="dialogValue" width="500" persistent>
    ...
    <!-- Dialog Content -->
    <VCard title="Impact (Fraud Schemes Assessment)">
      <VCardText>
        <AppSelect v-model="selectedMeasurement" class="mb-4" label="Pengukuran Dampak" :items="measurement" />
...
import { impactMeasurementAndLevels, impactResult } from '@/config/fraud';
...
const measurementAndLevels = impactMeasurementAndLevels
